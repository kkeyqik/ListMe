...
import { SearchCapsule } from '../components/search';
...
export default function Home() {
  ...
  const handleSearchSubmit = (e: React.FormEvent) => {
    ...
    // 5. Budget Filters (Scale: 10k/unit for Rent/Lease vs 1Cr/unit for Buy/Sale)
      ...
      <main style={{ flex: 1 }}>
        ...
        <div className={styles.heroCanvasWrapper}>
          ...
          <section className={styles.heroSection}>
              ...
              <div className={styles.heroLeft}>
                ...
                <div className={`${styles.circularTrustCard} hero-left-animate`}>
                  <div className={styles.trustThumbnails}>
                    <Image src={avatars[0]} alt="User Avatar 1" width={32} height={32} className={styles.trustThumb} />
                    <Image src={avatars[1]} alt="User Avatar 2" width={32} height={32} className={styles.trustThumb} />
                    <Image src={avatars[2]} alt="User Avatar 3" width={32} height={32} className={styles.trustThumb} />
                  </div>
            ...
            {/* Modular Search Bar Capsule */}
            <SearchCapsule searchLocation={searchLocation} />
